      ...
      <Accordion allowToggle>
        ...
        >
          <AccordionItem>
            ...
            <AccordionPanel pb={4} backgroundColor="white">
              ...
              plataforma y hacer clic en el botón Mis currículums. Luego, haz
              clic en el currículum que deseas editar. Se te darán opciones para
              editar la información de tu currículum.
            </AccordionPanel>
          </AccordionItem>
        </div>
        {/*Pregunta 3: */}
        ...
        >
          <AccordionItem>
            ...
            <AccordionPanel pb={4} backgroundColor="white">
              Para agregar habilidades a tu perfil, inicia sesión en la
              plataforma y haz clic en el botón Mi perfil. Luego, haz clic en la
              pestaña Habilidades y escribe las habilidades que deseas agregar.
            </AccordionPanel>
          </AccordionItem>
        </div>
        {/*Pregunta 5: */}
        ...
        >
          <AccordionItem>
            ...
            <AccordionPanel pb={4} backgroundColor="white">
              Para aplicar a una oferta de trabajo, inicia sesión en la
              plataforma y haz clic en el botón Ofertas de trabajo. Luego, haz
              clic en la oferta de trabajo a la que deseas aplicar. Se te pedirá
              que cargues tu currículum y una carta de presentación.
            </AccordionPanel>
          </AccordionItem>
        </div>
        {/*Pregunta 8: */}
        ...
        >
          <AccordionItem>
            ...
            <AccordionPanel pb={4} backgroundColor="white">
              Si deseas cancelar el envío de tu solicitud de empleo, inicia
              sesión en la plataforma y haz clic en el botón Ofertas de trabajo.
              Luego, haz clic en la oferta de trabajo a la que solicitaste
              empleo. Se te pedirá que confirmes que deseas cancelar la
              solicitud.
            </AccordionPanel>
          </AccordionItem>
        </div>
